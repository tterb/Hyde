...
* Before creating bug reports, please check the [existing issues](http://github.com/JonSn0w/Hyde/issues) as you might find out that one has already been created by another user.
 ...
 * Consider starting the commit message with an applicable emoji:
    ...
    * :triangular_ruler: `:triangular_ruler:` when improving the format/structure of the code or application
    * :racehorse: `:racehorse:` when improving performance
    * :non-potable_water: `:non-potable_water:` when plugging memory leaks
    * :books: `:books:` when updating or improving documentation
